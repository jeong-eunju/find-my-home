...
sns.heatmap(df[['SalePrice', 'OverallQual', 'FullBath', 'GarageCars']].corr(), 
            annot=True, cmap='coolwarm')
plt.title('🏘️ 주요 변수와 집값의 상관관계')
plt.show()
...
<iframe src="map_filtered.html" width="100%" height="600px" style="border:none;"></iframe>
